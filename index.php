                    ...
                    <div class="right-caption">
                        ...
                        <div class="support-caption">
                            <p class="mb-10">Sedac odio aliquet, fringilla odio eget, tincidunt nunc. Duis aliquet
                                pulvinar ante tempor etiam lacus eros</p>
                            <p class="pera-top">The legal definition of a charitable organization (and of charity)
                                varies between countries and in some instances regions of the country. The regulation,
                                the tax treatment, and the way in which charity law affects charitable organizations
                                also vary.</p>
                            <a href="about.php" class="btn about-btn">Learn More</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="single-emargency">
                        <div class="emargency-cap">
                            ...
                            <p>Sedac odio aliquet, fringilla odio eget, tincidunt nunc. Duis aliquet pulvinar ante
                                tempor etiam lacus eros</p>
                            <p class="emargenc-cap">Sedac odio aliquet, fringilla odio eget, tincidunt nunc. Duis
                                aliquet pulvinar ante tempor etiam lacus eros</p>
                ...
                <div class="col-xl-4 col-lg-5 col-md-10">
                    <div class="joing-details">
                        ...
                        <p>The legal definition of a charitable organization (and of charity) varies between countries
                            and in some instances regions of the country. The regulation, the tax treatment, and the
                            way.</p>
                        <a href="about.php" class="btn about-btn">Join Now</a>
                    </div>
                </div>
